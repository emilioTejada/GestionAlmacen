...
insert into producto (ref, nombre, descripcion, precio, cantidad) values ('02', 'Bomba neutrones', 'La estrella de la muerte sufrirá con ella', 99.3, 10);
insert into producto (ref, nombre, descripcion, precio, cantidad) values ('03', 'Halcón milenario', 'Con 5 años de garantía', 99.3, 10);
...
insert into producto (ref, nombre, descripcion, precio, cantidad) values ('06', 'Máquina del tiempo', 'Tus vacaciones durarán lo que quieras', 99.3, 10);
insert into producto (ref, nombre, descripcion, precio, cantidad) values ('07', 'Ford fiesta', 'Para tus viajes en la ciudad', 99.3, 10);
insert into producto (ref, nombre, descripcion, precio, cantidad) values ('08', 'Bola de dragón', 'La auténtica', 99.3, 10);
...
insert into producto (ref, nombre, descripcion, precio, cantidad) values ('10', 'La bola del Señor de los anillos', 'Esa con un ojo dentro', 99.3, 10);
...
insert into cliente (dni, nombre, apellidos, direccion) values ('05', 'Andrés', 'Argenta', 'Paseo de la estacion 35' );
